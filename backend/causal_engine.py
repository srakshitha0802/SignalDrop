...
to prove system reasons rather than memorizes.
"""
...
class CausalEngine:
    ...
    def _explain_threshold_crossing(self, significant_changes: List[Dict]) -> str:
        ...
        return f"This combination crossed risk momentum threshold. Total risk contribution: {total_contribution:.2f}. Key changes: {changes_str}."
